...
echo "  1. If prompted to reboot (kernel update), run: sudo reboot"
echo "  2. Run: openclaw status"
echo "  3. Add your AI provider: openclaw auth add anthropic"
echo "  4. Edit config: nano ~/.openclaw/openclaw.json"
echo "  5. Link WhatsApp: openclaw whatsapp link"
echo "  6. See the full guide for auth setup: https://docs.google.com/document/d/1KgA-KEZMJm9tdOo4_XjIKfoIuN0WQ06aDAW183X1N2g"
echo ""
